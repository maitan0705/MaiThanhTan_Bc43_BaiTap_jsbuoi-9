...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  var valid = true;
    ...
    valid = check.checkEmty(nv.account,'error-required-account','Tài Khoản')&check.checkEmty(nv.yourName,'error-required-yourName','Tên Nhân Viên')&check.checkEmty(nv.email,'error-required-email','Email')&check.checkEmty(nv.password,'error-required-password','Mật Khẩu')&check.checkEmty(nv.salary,'error-required-salary','Lương Cơ Bản')&check.checkEmty(nv.ti,'error-required-ti','Giờ Làm');
    ...
    valid = valid & check.checkNumber(nv.ti,'error-ti','Giờ Làm',80,200);
