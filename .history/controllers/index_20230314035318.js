...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  var valid = true;
    ...
    valid = check.checkEmty(account,'tbTKNV','Tài Khoản')
    &&check.checkEmty(yourName,'tbTen','Tên Nhân Viên')&&check.checkEmty(email,'tbEmail','Email')&&check.checkEmty(password,'tbMatKhau','Mật Khẩu')&&check.checkEmty(salary,'tbLuongCB','Lương Cơ Bản')&&check.checkEmty(timework,'tbGiolam','Giờ Làm');
    valid = valid && check.checkLetter(yourName,'tbTen','Tên Nhân Viên');
    valid = valid && check.checkemail(email,'tbEmail','Email');
    valid = valid && check.checkLength(account,'tbTKVN','Tài Khoản',4,6);
    valid = valid && check.checkPassword(password,'tbMatKhau','Mật Khẩu',6,10);
    valid = valid && check.checkNumber(salary,'TbLuongCB','Lương Cơ Bản',1000000,20000000);
    valid = valid && check.checkRole(luongChucVu,'tbChucVu');
    valid = valid && check.checkNumber(timework,'TbGioLam','Giờ Làm',80,200);
