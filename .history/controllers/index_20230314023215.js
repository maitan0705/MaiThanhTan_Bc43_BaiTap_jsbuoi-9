...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  var valid = true;
    ...
    valid = check.checkEmty(nv.account,'error-required-account','Tài Khoản')&check.checkEmty(nv.yourName,'error-required-yourName','Tên Nhân Viên')&check.checkEmty(nv.email,'error-required-email','Email')&check.checkEmty(nv.password,'error-required-password','Mật Khẩu')&check.checkEmty(nv.sa,'error-required-sa','Lương Cơ Bản')&check.checkEmty(nv.gioLam,'error-required-gioLam','Giờ Làm');
    ...
    valid = valid & check.checkNumber(nv.sa,'error-sa','Lương Cơ Bản',1000000,20000000);
