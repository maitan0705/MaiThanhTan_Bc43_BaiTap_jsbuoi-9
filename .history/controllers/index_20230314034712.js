...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  var valid = true;
    ...
    &&check.checkEmty(nv.yourName,'tbTen','Tên Nhân Viên')&&check.checkEmty(nv.email,'tbEmail','Email')&&check.checkEmty(nv.password,'tbMatKhau','Mật Khẩu')&&check.checkEmty(nv.salary,'error-required-luongCB','Lương Cơ Bản')&&check.checkEmty(nv.timework,'error-required-gioLam','Giờ Làm');
