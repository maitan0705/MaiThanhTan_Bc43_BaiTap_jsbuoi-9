...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  valid =
    check.checkR(nv.account, "tbTKNV", "Tài Khoản") &
    check.checkR(nv.yourName, "tbTen", "Tên Nhân Viên") &
    check.checkR(nv.email, "tbEmail", "Email") &
    check.checkR(nv.password, "tbMatKhau", "Mật Khẩu") &
    check.checkR(nv.salary, "tbLuongCB", "Lương Cơ Bản") &
    check.checkR(nv.timework, "tbGioLam", "Giờ Làm");
...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  valid =
    check.checkR(nhanVienEdit.account, "tbTKNV", "Tài Khoản") &
    check.checkR(nhanVienEdit.yourName, "tbTen", "Tên Nhân Viên") &
    check.checkR(nhanVienEdit.email, "tbEmail", "Email") &
    check.checkR(nhanVienEdit.password, "tbMatKhau", "Mật Khẩu") &
    check.checkR(nhanVienEdit.salary, "tbLuongCB", "Lương Cơ Bản") &
    check.checkR(nhanVienEdit.timework, "tbGioLam", "Giờ Làm");
