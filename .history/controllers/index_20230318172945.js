...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  valid =
    check.chek(nv.account, "tbTKNV", "Tài Khoản") &
    check.chek(nv.yourName, "tbTen", "Tên Nhân Viên") &
    check.chek(nv.email, "tbEmail", "Email") &
    check.chek(nv.password, "tbMatKhau", "Mật Khẩu") &
    check.chek(nv.salary, "tbLuongCB", "Lương Cơ Bản") &
    check.chek(nv.timework, "tbGioLam", "Giờ Làm");
...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  valid =
    check.chek(nhanVienEdit.account, "tbTKNV", "Tài Khoản") &
    check.chek(nhanVienEdit.yourName, "tbTen", "Tên Nhân Viên") &
    check.chek(nhanVienEdit.email, "tbEmail", "Email") &
    check.chek(nhanVienEdit.password, "tbMatKhau", "Mật Khẩu") &
    check.chek(nhanVienEdit.salary, "tbLuongCB", "Lương Cơ Bản") &
    check.chek(nhanVienEdit.timework, "tbGioLam", "Giờ Làm");
