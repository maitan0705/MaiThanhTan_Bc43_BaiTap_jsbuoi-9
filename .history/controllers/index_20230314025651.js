...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  var valid = true;
    ...
    valid = check.checkEmty(nv.account,'error-required-tknv','Tài Khoản')&check.checkEmty(nv.yourName,'error-required-name','Tên Nhân Viên')&check.checkEmty(nv.email,'error-required-email','Email')&check.checkEmty(nv.password,'error-required-password','Mật Khẩu')&check.checkEmty(nv.salary,'error-required-luongCB','Lương Cơ Bản')&check.checkEmty(nv.timework,'error-required-timework','Giờ Làm');
