...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  valid =
    check.che(nv.account, "tbTKNV", "Tài Khoản") &
    check.che(nv.yourName, "tbTen", "Tên Nhân Viên") &
    check.che(nv.email, "tbEmail", "Email") &
    check.che(nv.password, "tbMatKhau", "Mật Khẩu") &
    check.che(nv.salary, "tbLuongCB", "Lương Cơ Bản") &
    check.che(nv.timework, "tbGioLam", "Giờ Làm");
...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  valid =
    check.che(nhanVienEdit.account, "tbTKNV", "Tài Khoản") &
    check.che(nhanVienEdit.yourName, "tbTen", "Tên Nhân Viên") &
    check.che(nhanVienEdit.email, "tbEmail", "Email") &
    check.che(nhanVienEdit.password, "tbMatKhau", "Mật Khẩu") &
    check.che(nhanVienEdit.salary, "tbLuongCB", "Lương Cơ Bản") &
    check.che(nhanVienEdit.timework, "tbGioLam", "Giờ Làm");
