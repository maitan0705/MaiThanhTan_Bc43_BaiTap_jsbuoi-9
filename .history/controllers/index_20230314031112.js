...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  valid = check.checkEmty(nhanVienEdit.account,'error-required-account','Tài Khoản')&check.checkEmty(nhanVienEdit.yourName,'error-required-yourName','Tên Nhân Viên')&check.checkEmty(nhanVienEdit.email,'error-required-email','Email')&check.checkEmty(nhanVienEdit.password,'error-required-password','Mật Khẩu')&check.checkEmty(nhanVienEdit.salary,'error-required-salary','Lương Cơ Bản')&check.checkEmty(nhanVienEdit.timework,'error-required-','Giờ Làm');
