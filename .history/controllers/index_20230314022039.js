...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  valid = check.checkEmty(capNhatNV.ac,'error-required-tknv','Tài Khoản')&check.checkEmty(capNhatNV.yourName,'error-required-name','Tên Nhân Viên')&check.checkEmty(capNhatNV.email,'error-required-email','Email')&check.checkEmty(capNhatNV.password,'error-required-password','Mật Khẩu')&check.checkEmty(capNhatNV.luongCB,'error-required-luongCB','Lương Cơ Bản')&check.checkEmty(capNhatNV.gioLam,'error-required-gioLam','Giờ Làm');
