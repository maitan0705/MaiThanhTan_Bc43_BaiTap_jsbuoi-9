...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  valid = valid & check.checkNumber(capNhatNV.timework,'error-t','Giờ Làm',80,200);
  if(!valid){
      return ;
  }
