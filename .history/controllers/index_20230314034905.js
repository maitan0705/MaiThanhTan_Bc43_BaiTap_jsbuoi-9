...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  var valid = true;
    ...
    &&check.checkEmty(nv.yourName,'tbTen','Tên Nhân Viên')&&check.checkEmty(nv.email,'tbEmail','Email')&&check.checkEmty(nv.password,'tbMatKhau','Mật Khẩu')&&check.checkEmty(nv.salary,'tbLuongCB','Lương Cơ Bản')&&check.checkEmty(nv.timework,'tbGiolamerror-required-gioLam','Giờ Làm');
