...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  var valid = true;
    ...
    valid = check.checkEmty(nhaaccount,'tbTKNV','Tài Khoản')
    &&check.checkEmty(nhayourName,'tbTen','Tên Nhân Viên')&&check.checkEmty(nhaemail,'tbEmail','Email')&&check.checkEmty(nhapassword,'tbMatKhau','Mật Khẩu')&&check.checkEmty(nhasalary,'tbLuongCB','Lương Cơ Bản')&&check.checkEmty(nhatimework,'tbGiolam','Giờ Làm');
    valid = valid && check.checkLetter(nhayourName,'tbTen','Tên Nhân Viên');
    valid = valid && check.checkemail(nhaemail,'tbEmail','Email');
    valid = valid && check.checkLength(nhaaccount,'tbTKVN','Tài Khoản',4,6);
    valid = valid && check.checkPassword(nhapassword,'tbMatKhau','Mật Khẩu',6,10);
    valid = valid && check.checkNumber(nhasalary,'TbLuongCB','Lương Cơ Bản',1000000,20000000);
    valid = valid && check.checkRole(nhaluongChucVu,'tbChucVu');
    valid = valid && check.checkNumber(nhatimework,'TbGioLam','Giờ Làm',80,200);
