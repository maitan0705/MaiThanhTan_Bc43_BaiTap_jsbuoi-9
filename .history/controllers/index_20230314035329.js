...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  var valid = true;
    ...
    valid = check.checkEmty(nhanVienEditaccount,'tbTKNV','Tài Khoản')
    &&check.checkEmty(nhanVienEdityourName,'tbTen','Tên Nhân Viên')&&check.checkEmty(nhanVienEditemail,'tbEmail','Email')&&check.checkEmty(nhanVienEditpassword,'tbMatKhau','Mật Khẩu')&&check.checkEmty(nhanVienEditsalary,'tbLuongCB','Lương Cơ Bản')&&check.checkEmty(nhanVienEdittimework,'tbGiolam','Giờ Làm');
    valid = valid && check.checkLetter(nhanVienEdityourName,'tbTen','Tên Nhân Viên');
    valid = valid && check.checkemail(nhanVienEditemail,'tbEmail','Email');
    valid = valid && check.checkLength(nhanVienEditaccount,'tbTKVN','Tài Khoản',4,6);
    valid = valid && check.checkPassword(nhanVienEditpassword,'tbMatKhau','Mật Khẩu',6,10);
    valid = valid && check.checkNumber(nhanVienEditsalary,'TbLuongCB','Lương Cơ Bản',1000000,20000000);
    valid = valid && check.checkRole(nhanVienEditluongChucVu,'tbChucVu');
    valid = valid && check.checkNumber(nhanVienEdittimework,'TbGioLam','Giờ Làm',80,200);
