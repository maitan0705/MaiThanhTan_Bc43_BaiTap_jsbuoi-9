...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  valid = check.checkEmty(capNhatNV.account,'error-required-tknv','Tài Khoản')&check.checkEmty(capNhatNV.yourName,'error-required-name','Tên Nhân Viên')&check.checkEmty(capNhatNV.email,'error-required-email','Email')&check.checkEmty(capNhatNV.password,'error-required-password','Mật Khẩu')&check.checkEmty(capNhatNV.salary,'error-required-luongCB','Lương Cơ Bản')&check.checkEmty(capNhatNV.timework,'error-required-gioLam','Giờ Làm');
