...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  valid = check.checkNumber(nv.timework, 'tbLuongCB',"Lương cơ bản ",1000000, 20000000, "error-tbLuongCB");
  valid = check.checkNumber(nv.salary, 'tbLuongCB',"Lương cơ bản ",1000000, 20000000, "error-gioLam");
  if (!valid) {
    return;
  }
