...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  var valid = true;
    ...
    valid = check.checkEmty(nv.account,'error-required-account','Tài Khoản')&check.checkEmty(nv.,'error-required-','Tên Nhân Viên')&check.checkEmty(nv.email,'error-required-email','Email')&check.checkEmty(nv.password,'error-required-password','Mật Khẩu')&check.checkEmty(nv.luongCB,'error-required-luongCB','Lương Cơ Bản')&check.checkEmty(nv.gioLam,'error-required-gioLam','Giờ Làm');
    valid = valid & check.checkLetter(nv.,'error-AllLetter-','Tên Nhân Viên');
