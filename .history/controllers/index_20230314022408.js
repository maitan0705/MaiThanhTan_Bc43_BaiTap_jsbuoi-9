...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  valid = valid & check.checkNumber(capNhatNV.timework,'error-ti','Giờ Làm',80,200);
  if(!valid){
      return ;
  }
