...
document.querySelector("#btnThemNV").onclick = function () {
  ...
  valid =
    check.(nv.account, "tbTKNV", "Tài Khoản") &
    check.(nv.yourName, "tbTen", "Tên Nhân Viên") &
    check.(nv.email, "tbEmail", "Email") &
    check.(nv.password, "tbMatKhau", "Mật Khẩu") &
    check.(nv.salary, "tbLuongCB", "Lương Cơ Bản") &
    check.(nv.timework, "tbGioLam", "Giờ Làm");
...
document.getElementById("btnCapNhat").onclick = function () {
  ...
  valid =
    check.(nhanVienEdit.account, "tbTKNV", "Tài Khoản") &
    check.(nhanVienEdit.yourName, "tbTen", "Tên Nhân Viên") &
    check.(nhanVienEdit.email, "tbEmail", "Email") &
    check.(nhanVienEdit.password, "tbMatKhau", "Mật Khẩu") &
    check.(nhanVienEdit.salary, "tbLuongCB", "Lương Cơ Bản") &
    check.(nhanVienEdit.timework, "tbGioLam", "Giờ Làm");
